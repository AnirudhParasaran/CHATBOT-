...
async def handle_request(request: Request):
    ...
    session_id = regex.extract_session_id(output_contexts[0]['name'])
    ...
    if session_id not in inprogress_orders:
        ...
        if order_id == -1:
            ...
            fulfillment_text = f"Awesome. We have placed your order."\
                               ...
                               f"Your order total us {order_total} which you can pay at the time of delivery!"
...
def remove_from_order(parameters: dict, session_id: str):
    ...
    if len(current_order.keys()) == 0:
        ...
        order_str = regex.get_str_from_food_dict(current_order)
...
def add_to_order(parameters: dict, session_id: str):
    ...
    if len(food_items) != len(quantities):
        ...
        order_str = regex.get_str_from_food_dict(inprogress_orders[session_id])
